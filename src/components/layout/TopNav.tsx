...
export function TopNav() {
  ...
  return (
    <header
      className="sticky top-0 z-40 w-full border-b border-border/60 bg-card/90 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.05)] transition-all"
      style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}
    >
      {/* Actual nav content row – sits below the status bar inset */}
      <div className="flex h-14 items-center justify-between px-3 sm:px-4 md:h-16 lg:px-6">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-8.5 w-8.5 rounded-full p-0 active:scale-95 transition-transform"
              >
