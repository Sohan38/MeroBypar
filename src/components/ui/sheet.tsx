...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background p-6 shadow-2xl transition ease-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
